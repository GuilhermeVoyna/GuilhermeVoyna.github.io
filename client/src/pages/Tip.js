      ...
      <div className="tip">
        ...
        <form onSubmit={handleSubmit}>
          <section>
            ...
            <div className="multiple-container">
              ...
              <input
                ...
                value={"restaurante"}
                onChange={handleChange}
                checked={tipData.type==='restaurante'}
              />
              ...
              <input
                ...
                value={"hospedagem"}
                onChange={handleChange}
                checked={tipData.type==='hospedagem'}
              />
          ...
          <section>
            ...
            {tipData.url && <img src={tipData.url} alt="profile pic preview"/>}
            </div>
            <input type="submit" />
          </section>
        </form>
